...
pygame.display.set_caption("Practice AIM")
...
def draw_top_bar(win,elapsed_time,targets_pressed,misses):
    ...
    speed_label=LABEL_FONT.render(f"Speed :{speed} targets/sec",True,"black")
...
def end_screen(win,elapsed_time,targets_pressed,clicks):
    ...
    speed = round(targets_pressed / elapsed_time, 1)
    speed_label = LABEL_FONT.render(f"Speed :{speed} targets/sec", True, "white")
